...
class DirectorySpecSchema(BaseModel):
    ...
    cd: Optional[str] = Field(
        None, description="Directory containing Class Design Document"
    )
    md: Optional[str] = Field(
        None, description="Directory containing Method Design Document"
    )
    id: Optional[str] = Field(
        None, description="Directory containing Interface Design Document"
    )
    fs: Optional[str] = Field(
        None, description="Directory containing Folder Structure Design Document"
    )
    ac: Optional[str] = Field(None, description="Directory containing Activity diagram")
...
class ProjectCreateRequestSchema(BaseModel):
    ...
    directory_spec: DirectorySpecSchema = Field(
        ..., description="Project directory information"
    )
