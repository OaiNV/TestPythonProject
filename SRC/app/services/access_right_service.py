...
from CEC_DocifyCode_Common.repositories.access_right_repository import (
...
class AccessRightService:
    """Service for access right operations - Singleton pattern"""
    ...
    def __init__(self):
        if not self._initialized:
            self.repository = access_right_repository
...
def get_access_right_service():
    """Get the global access right service instance"""
    return access_right_service
