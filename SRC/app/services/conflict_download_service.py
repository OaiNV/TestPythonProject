...
class ConflictDownloadService:
    ...
    async def _ensure_access(self, project_id: str, user_id: str) -> Any:
        ...
        try:
            ...
            error_message = "[_ensure_access] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    async def _collect_file_payloads(
        ...
        try:
            ...
            error_message = "[_collect_file_payloads] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    async def _fetch_document(
        ...
        try:
            ...
            error_message = "[_fetch_document] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _extract_file_bytes(
        ...
        try:
            ...
            error_message = "[_extract_file_bytes] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _build_zip_entry_path(
        ...
        try:
            ...
            error_message = "[_build_zip_entry_path] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    async def _create_zip_file(
        ...
        try:
            ...
            error_message = "[_create_zip_file] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _zip_content_extractor(document: Dict[str, Any]) -> Tuple[str, bytes]:
        ...
        try:
            ...
            error_message = "[_zip_content_extractor] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _normalize_conflict_item(item: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            error_message = "[_normalize_conflict_item] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _extract_project_name(project: Any) -> str:
        ...
        try:
            ...
            error_message = "[_extract_project_name] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _sanitize_name(name: str) -> str:
        ...
        try:
            ...
            error_message = "[_sanitize_name] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _extract_source_code_content(document: Dict[str, Any]) -> Tuple[str, bytes]:
        ...
        try:
            ...
            error_message = "[_extract_source_code_content] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _extract_unit_test_design_content(
        ...
        try:
            ...
            error_message = "[_extract_unit_test_design_content] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
    ...
    def _extract_unit_test_code_content(document: Dict[str, Any]) -> Tuple[str, bytes]:
        ...
        try:
            ...
            error_message = "[_extract_unit_test_code_content] Error: %s" % (
                e,
            )
            logger.error(error_message)
            save_exception_log_sync(e, error_message, __name__)
