...
from app.services.mock_data_service import MOCK_DECISION_TABLE, MOCK_TEST_PATTERN
    ...
    async def get_unit_test_design_detail(
        ...
        try:
            ...
            response_payload = {
                ...
                "unit_test_designs": [
                    self._map_unit_test_design_fields(document)
    ...
    def _map_unit_test_design_fields(self, document: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            mapped = {
                ...
                "decision_table": document.get("decision_table") or MOCK_DECISION_TABLE,
