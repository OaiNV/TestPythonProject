...
from CEC_DocifyCode_Common.repositories.local_login_repository import local_login_repository
...
class LocalLoginService:
    """Service for managing local login data - Singleton pattern"""
    ...
    def __init__(self):
        if not LocalLoginService._initialized:
            self.repository = local_login_repository
