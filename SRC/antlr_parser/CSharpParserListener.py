...
class CSharpParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CSharpParser#global_statement.
    def enterGlobal_statement(self, ctx:CSharpParser.Global_statementContext):
        pass

    # Exit a parse tree produced by CSharpParser#global_statement.
    def exitGlobal_statement(self, ctx:CSharpParser.Global_statementContext):
        pass
    ...
    # Enter a parse tree produced by CSharpParser#global_method_declaration.
    def enterGlobal_method_declaration(self, ctx:CSharpParser.Global_method_declarationContext):
        pass

    # Exit a parse tree produced by CSharpParser#global_method_declaration.
    def exitGlobal_method_declaration(self, ctx:CSharpParser.Global_method_declarationContext):
        pass
